...
<button type="button" id="lpc-ai-chat-launcher" class="lpc-ai-chat-launcher"
        ...
        title="<?= $en ? 'Ask the AI assistant' : "Demander à l'assistant IA" ?>">
...
<div id="lpc-ai-chat-panel" class="lpc-ai-chat-panel" hidden role="dialog" aria-modal="false"
     aria-label="<?= $en ? 'AI assistant' : 'Assistant IA' ?>" data-lang="<?= $lang ?>">

    <div class="lpc-ai-chat-head">
        <div>
            <p class="lpc-ai-chat-eyebrow"><?= $en ? 'HELP CENTRE ASSISTANT' : "ASSISTANT DU CENTRE D'AIDE" ?></p>
    ...
    <div id="lpc-ai-chat-messages" class="lpc-ai-chat-messages" aria-live="polite">
        <div class="lpc-ai-chat-msg lpc-ai-chat-msg--bot">
            <div class="lpc-ai-chat-bubble">
                <p><?= $en
                    ? "Hi! Ask me anything about the ERP — I'll search the help articles you have access to and answer from those, with links to the sources."
                    : "Bonjour ! Posez-moi une question sur l'ERP — je chercherai dans les articles d'aide auxquels vous avez accès et je répondrai à partir de ceux-ci, avec des liens vers les sources." ?></p>
            </div>
        </div>
    </div>
