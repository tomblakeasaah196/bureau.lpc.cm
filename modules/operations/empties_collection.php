...
<head>
    ...
    <title>Collecte & Recyclage | LPC ERP</title>
        ...
        <main role="main" id="main" class="lpc-page relative">
            ...
            <div id="content-owed" class="tab-content active max-w-4xl mx-auto pb-20">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-3">
                    <h2 class="text-sm font-black text-gray-800 uppercase tracking-widest">Soldes Clients (À Récupérer)</h2>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left border-collapse min-w-[600px]">
                            <thead class="bg-gray-50 text-[10px] uppercase text-gray-400 font-black tracking-widest border-b border-gray-200">
                                <tr>
                                    <th class="py-3 px-4">Client / Site</th>
                                    <th class="py-3 px-4">Type Bouteille</th>
                                    <th class="py-3 px-4 text-center text-blue-500" title="Total Livré">Livrés (Out)</th>
                                    <th class="py-3 px-4 text-center text-green-500" title="Total Rendu">Rendus (In)</th>
                                    <th class="py-3 px-4 text-center text-rose-500 bg-rose-50" title="Actuellement Dû">Solde (Dû)</th>
                                    <th class="py-3 px-4 text-right">Action</th>
                                </tr>
                            </thead>
                            <tbody id="tbody-owed" class="divide-y divide-gray-100 text-sm">
                                <tr><td colspan="6" class="text-center py-8 text-gray-400 font-bold"><i class="fas fa-spinner fa-spin"></i> Chargement...</td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
            ...
            <div id="content-new" class="tab-content max-w-2xl mx-auto pb-20">
                <form id="form-cre" class="space-y-6">
                    <div class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
                        <h3 class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3"><i class="fas fa-building mr-1"></i> 1. Identification du Client</h3>
                        <div class="space-y-4">
                            <div>
                                <label class="block text-xs font-bold text-gray-700 mb-1">Client Principal *</label>
                            ...
                            <div id="site_container" class="hidden">
                                <label class="block text-xs font-bold text-gray-700 mb-1">Site / Succursale (Optionnel)</label>
                                <select id="site_id" class="w-full bg-blue-50 border border-blue-100 rounded-xl p-3 text-sm font-bold text-blue-900 outline-none focus:ring-2 focus:ring-blue-500">
                                    <option value="">-- Siège Principal --</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
                        <h3 class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3"><i class="fas fa-wine-bottle mr-1"></i> 2. Quantités Récupérées</h3>
                        <div class="grid grid-cols-2 gap-4">
                            <div class="bg-gray-50 p-3 rounded-xl border border-gray-200 text-center">
                                <p class="text-xs font-black text-gray-800 mb-2">Bouteilles 20L</p>
                                <div class="space-y-3">
                                    <div>
                                        <label class="text-[10px] font-bold text-gray-500 uppercase">Avec Bouchon</label>
                                    ...
                                    <div>
                                        <label class="text-[10px] font-bold text-rose-500 uppercase">SANS Bouchon</label>
                            ...
                            <div class="bg-gray-50 p-3 rounded-xl border border-gray-200 text-center">
                                <p class="text-xs font-black text-gray-800 mb-2">Bouteilles 10L</p>
                                <div class="space-y-3">
                                    <div>
                                        <label class="text-[10px] font-bold text-gray-500 uppercase">Avec Bouchon</label>
            ...
            <div id="content-recycling" class="tab-content max-w-2xl mx-auto pb-20">
                <form id="form-recycle" class="space-y-6">
                    ...
                    <div class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
                        <h3 class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3"><i class="fas fa-map-marker-alt mr-1"></i> 1. Lieu de Recyclage</h3>
                    ...
                    <div class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
                        <div class="flex justify-between items-center mb-3">
                            <h3 class="text-[10px] font-black text-gray-400 uppercase tracking-widest"><i class="fas fa-recycle mr-1"></i> 2. Quantités Vendues</h3>
                            <span class="text-[10px] font-bold text-amber-600 bg-amber-50 px-2 py-1 rounded-lg border border-amber-200">Paiement Cash</span>
                        </div>

                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div class="bg-gray-50 p-3 rounded-xl border border-gray-200 text-center">
                                <p class="text-xs font-black text-gray-800 mb-1">Bouteilles 20L</p>
                                <div class="space-y-3">
                                    <div>
                            ...
                            <div class="bg-gray-50 p-3 rounded-xl border border-gray-200 text-center">
                                <p class="text-xs font-black text-gray-800 mb-1">Bouteilles 10L</p>
                                <div class="space-y-3">
                                    <div>
                                        <div class="flex justify-between items-center mb-1">
                                            <label class="text-[10px] font-bold text-gray-500 uppercase">Avec Bouchon</label>
                        ...
                        <div class="bg-amber-50 p-4 rounded-xl text-center border border-amber-200 mt-2">
                            <p class="text-[10px] font-black uppercase tracking-widest text-amber-700">Cash Total Attendu en Caisse</p>
            ...
            <div id="content-history" class="tab-content max-w-2xl mx-auto pb-20">
                <div class="flex justify-between items-center mb-4">
                    <h2 class="text-sm font-black text-gray-800 uppercase tracking-widest">Vos Collectes Récentes</h2>
            ...
            <div id="content-revenue" class="tab-content max-w-4xl mx-auto pb-20">
                <div class="flex justify-between items-center mb-4">
                    <h2 class="text-sm font-black text-gray-800 uppercase tracking-widest">Tableau de Bord Financier (Vides)</h2>
                    <button onclick="loadRevenueData()" class="text-lpc-dark hover:text-green-700 transition-colors"><i class="fas fa-sync-alt"></i> Actualiser</button>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    <div class="bg-emerald-600 p-5 rounded-2xl shadow-lg text-white">
                        <p class="text-[10px] font-black uppercase tracking-widest opacity-80">Revenu Total</p>
                    ...
                    <div class="md:col-span-2 bg-white border border-gray-200 p-4 rounded-2xl shadow-sm grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div class="text-center border-r border-gray-100">
                            <p class="text-[9px] font-black text-gray-400 uppercase">20L (Bouchon)</p>
                            <p class="text-xl font-black text-gray-800" id="stat_20c">0</p>
                        </div>
                        <div class="text-center md:border-r border-gray-100">
                            <p class="text-[9px] font-black text-rose-400 uppercase">20L (Sans B.)</p>
                            <p class="text-xl font-black text-rose-600" id="stat_20n">0</p>
                        </div>
                        <div class="text-center border-r border-gray-100">
                            <p class="text-[9px] font-black text-gray-400 uppercase">10L (Bouchon)</p>
                            <p class="text-xl font-black text-gray-800" id="stat_10c">0</p>
                        </div>
                        <div class="text-center">
                            <p class="text-[9px] font-black text-rose-400 uppercase">10L (Sans B.)</p>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="overflow-x-auto">
                        <table class="w-full text-left border-collapse min-w-[600px]">
                            <thead class="bg-gray-50 text-[10px] uppercase text-gray-400 font-black tracking-widest border-b border-gray-200">
                                <tr>
                                    <th class="py-3 px-4">Date & Référence</th>
                                    <th class="py-3 px-4">Chauffeur / Agent</th>
                                    <th class="py-3 px-4">Centre de Recyclage</th>
                                    <th class="py-3 px-4 text-right">Montant Encaissé</th>
                                </tr>
                            </thead>
                            <tbody id="tbody-revenue" class="divide-y divide-gray-100 text-sm">
                                <tr><td colspan="4" class="text-center py-8 text-gray-400 font-bold"><i class="fas fa-spinner fa-spin"></i> Chargement...</td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
    ...
    <div id="modal-share" class="hidden fixed inset-0 z-50 flex items-end md:items-center justify-center bg-gray-900/90 backdrop-blur-sm transition-opacity">
        <div class="bg-white rounded-t-3xl md:rounded-3xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col animate-slide-up">
            <div class="bg-gray-50 p-6 text-center border-b border-gray-200 relative">
                ...
                <p class="text-xs font-bold text-gray-500 mt-1">Réf: <span id="share_ref" class="text-lpc-dark font-black">CRE-...</span></p>
            </div>
