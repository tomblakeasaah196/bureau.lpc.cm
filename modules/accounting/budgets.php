    ...
    <div class="flex-1 flex flex-col min-w-0 overflow-hidden relative">
        ...
        <header class="bg-white border-b border-gray-200 px-8 py-5 flex justify-between items-center shrink-0 z-20 shadow-sm relative">
            <div class="flex items-center gap-4">
                <div class="w-12 h-12 bg-finance-dark rounded-xl flex items-center justify-center text-white shadow-lg">
                    <i class="fas fa-chart-pie text-xl"></i>
                </div>
                <div>
                    <h1 class="text-2xl font-black text-gray-900 tracking-tight">Contrôle de Gestion</h1>
                    <p class="text-xs text-gray-500 font-bold uppercase tracking-widest mt-1">Budget, Performance & Reporting IFRS/OHADA</p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-4">
                <div class="bg-gray-100 p-1.5 rounded-lg border border-gray-200 flex items-center shadow-inner">
                    ...
                    <select id="global_year_filter" onchange="refreshAllTabs()" class="bg-white border border-gray-300 rounded text-sm font-black text-finance-dark px-3 py-1 outline-none focus:ring-2 focus:ring-finance-highlight">
        ...
        <main role="main" id="main" class="flex-1 overflow-y-auto p-8 flex flex-col relative bg-slate-50/80" id="report-container">
